...
public final class DbxClient
{
    ...
    public static final class Downloader
    {
        ...
        public void close()
        {
            try {
                ...
                // Don't care about IOExceptions on InputStreams because
                // we've already read what we wanted.
            }
        }
    }
        ...
        throws DbxException
    {
        ...
        return DbxRequestUtil.doPost(requestConfig, accessToken, host, apiPath, params, null, new DbxRequestUtil.ResponseHandler<DbxDelta<DbxEntry>>() {
            @Override
        ...
        throws DbxException
    {
        ...
        return DbxRequestUtil.doPost(requestConfig, accessToken, host, apiPath, new String[]{"cursor", cursor}, null, new DbxRequestUtil.ResponseHandler<DbxDeltaC<C, DbxEntry>>() {
            @Override
        ...
        throws DbxException
    {
        ...
        String apiPath = "1/thumbnails" + path;
        String[] params = {
            "size", size.ident,
            "format", format.ident,
            "rev", revision,
    ...
    // Convenience function that calls Util.doGet with the first three parameters filled in.
    ...
    public static final class Uploader
    {
            ...
            throws DbxException
        {
            ...
            long bytesWritten = this.countingStream.getBytesWritten();
